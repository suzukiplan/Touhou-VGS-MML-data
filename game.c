...
/* Macro */
#define HITCHK(X1, Y1, XS1, YS1, X2, Y2, XS2, YS2) \
  (X1 < X2 + XS2 && X2 < X1 + XS1 && Y1 < Y2 + YS2 && Y2 < Y1 + YS1)
#define TITLE_NUM 10
#define SONG_NUM 101
...
int vge_loop() {
    ...
    if (0 == touching) {
      if (!_listType && HITCHK(ci.cx - 4, ci.cy - 4, 8, 8, 224, 130, 16, 190)) {
        touching = 1;
                 ...
                 HITCHK(ci.cx - 4, ci.cy - 4, 8, 8, 0, 300, 240, 20)) {
        touching = 3;
      } else {
        touching = 2;
      }
  ...
  if (_listType) {
    if (PRF.lock && -1 != _mcur) {
      ...
      if (playingTitle != _title[_currentTitle].id) {
        ...
        for (ii = 0, iii = _currentTitle; playingTitle != _title[iii].id;
             ii++) {
          iii--;
  ...
  if (focus) {
    if (_listType &&
        ((_list[_mcur].id & 0xFFFF00) >> 8 != _title[_currentTitle].id)) {
      playingTitle = (_list[_mcur].id & 0xFFFF00) >> 8;
      if (playingTitle != _title[_currentTitle].id) {
        /* check pop count of right */
        for (i = 0, iii = _currentTitle; playingTitle != _title[iii].id; i++) {
  ...
  for (iii = 0; iii < 2; iii++) {
    ...
    if (_listType) {
      ...
      putkanji(236 + bx - ((int)strlen(_title[ct].copyright)) * 4,
               152 + (int)base, 255, _title[ct].copyright);
      if (_title[ct].id == 0x60) {
        putkanji((240 - (((int)strlen(_msg)) * 4)) / 2 + bx, 40 + (int)base,
                 255, "%s", _msg);
      }
    }
    /* Draw music list */
        ...
        if (!editmode && _list[i].dis) {
          ...
          if (_mcur == i) {
            ...
            if (ci.s && touch_off == 0 && 2 == touching &&
                ...
                HITCHK(4 + bx, dp, 216 + _listType * 16, 16, ci.cx - 4,
                       ci.cy - 4, 8, 8)) {
              ci.s = 0;
              if (selectSong != i) {
                selectTime = 0;
              ...
              if (selectTime < 4) {
                vge_boxfSP(4 + bx, dp, 220 + _listType * 16 + bx, dp + 16,
                           _list[i].col + 4 * _list[i].played);
  ...
  if (!_listType) {
    ...
    if (base >= 4) {
      ...
      if (1 == touching &&
          HITCHK(224, 130, 16, 12, ci.cx - 8, ci.cy - 8, 16, 16)) {
        touchSB = 30;
    ...
    if (base <= bmin) {
      ...
      if (1 == touching &&
          HITCHK(224, 308, 16, 12, ci.cx - 8, ci.cy - 8, 16, 16)) {
        touchSB = 30;
  ...
  if (ci.s && touch_off == 0 &&
      HITCHK(0, 0, 24, 12, ci.cx - 4, ci.cy - 4, 8, 8)) {
    if (_list == _listJ) {
  ...
  if (!editmode) {
    if (ci.s && touch_off == 0 &&
        HITCHK(220, 0, 20, 16, ci.cx - 4, ci.cy - 4, 8, 8)) {
  ...
  if (editmode) {
    ...
    for (i = 0; i < 3; i++) {
      if (i == _mylist.no) {
        ...
        if (ci.s && touch_off == 0 &&
            HITCHK(20 + i * 70, 32, 60, 18, ci.cx - 4, ci.cy - 4, 8, 8)) {
          vge_boxfSP(20 + i * 70, 32, 80 + i * 70, 50, 58);
          vge_boxSP(20 + i * 70, 32, 80 + i * 70, 50, 63);
          if (push) {
            vge_eff(2);
    ...
    if (k == SONG_NUM) {
      ...
      if (ci.s && touch_off == 0 &&
          HITCHK(4, 76, 42, 20, ci.cx - 4, ci.cy - 4, 8, 8)) {
    ...
    if (j == SONG_NUM) {
      ...
      if (ci.s && touch_off == 0 &&
          HITCHK(50, 76, 42, 20, ci.cx - 4, ci.cy - 4, 8, 8)) {
    ...
    if (_listType) {
      ...
      if (ci.s && touch_off == 0 &&
          HITCHK(108, 76, 44, 20, ci.cx - 4, ci.cy - 4, 8, 8)) {
        vge_boxfSP(108, 76, 152, 96, 58);
        vge_boxSP(108, 76, 152, 96, 63);
        if (push) {
          vge_eff(1);
    ...
    if (!_listType) {
      ...
      if (ci.s && touch_off == 0 &&
          HITCHK(156, 76, 44, 20, ci.cx - 4, ci.cy - 4, 8, 8)) {
        vge_boxfSP(156, 76, 200, 96, 58);
        vge_boxSP(156, 76, 200, 96, 63);
        if (push) {
          vge_eff(1);
  ...
  if (_mcur < 0) {
    ...
    if (_list[_mcur].loop) {
      if (infy) {
        ...
        if (_psg.loop < loop) {
          putfontS(8, 16, "INDEX     %05d  PLAYING %d OF %d", _psg.nidx,
                   _psg.loop + 1, loop);
        } else {
  ...
  for (i = 0; i < 6; i++) {
    ...
    if (_psg.wav[i] != 0 || _psg.ch[i].keyOn) {
      ...
      if (0 == j) {
        vge_boxfSP(k / 12 * 28 + ii * 4 + 36, 46 + i * 10,
                   k / 12 * 28 + ii * 4 + 38, 52 + i * 10, 31);
      } else {
        vge_boxfSP(k / 12 * 28 + ii * 4 + 38, 46 + i * 10,
                   k / 12 * 28 + ii * 4 + 40, 51 + i * 10, 31);
      }
    }
  }
...
SKIP_DRAW_PROC:
  ...
  /* LOCK button */
  if (ci.s && touch_off == 0 &&
      HITCHK(-24 + ii, 92, 24, 32, ci.cx - 4, ci.cy - 4, 8, 8)) {
  ...
  if (paused) {
    if (-1 == _mcur) {
      ...
      if (ci.s && touch_off == 0 &&
          HITCHK(2 + ii, 92, 24, 32, ci.cx - 4, ci.cy - 4, 8, 8)) {
  ...
  /* INFINITE button */
  if (ci.s && touch_off == 0 &&
      HITCHK(28 + ii, 92, 24, 32, ci.cx - 4, ci.cy - 4, 8, 8)) {
  ...
  if (!infy) {
    /* SHUFFLE button */
    if (ci.s && touch_off == 0 &&
        HITCHK(54 + ii, 92, 24, 32, ci.cx - 4, ci.cy - 4, 8, 8)) {
    ...
    if (-1 == _mcur || (0 <= _mcur && _list[_mcur].loop)) {
      if (ci.s && touch_off == 0 &&
          HITCHK(80 + ii, 92, 24, 32, ci.cx - 4, ci.cy - 4, 8, 8)) {
